...
while i < len(my_list):     # сравнение индекса и длинны строки не даёт выйти за его границу и позволяет повторять цикл
    if my_list[i] < 0:      # если значение по индексу будет меньше 0 то будет выполенно следущая строка
        break       # прерывает цикл
    if my_list[i] > 0:      # если значение по индексу будет больше 0 то будет выполенно следущая строка
